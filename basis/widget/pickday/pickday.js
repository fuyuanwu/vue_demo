 ...
 * Usage:
    var now = new Date();
    var last_week = new Date(now.getTime() - 604800000);
    var picker_start = new Pikaday({
        field: document.getElementById('J-start'),
        firstDay: 1,
        defaultDate: last_week,
        setDefaultDate: true,
...
(function(root, define, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define('js/widget/pikaday', function(req) {
    ...
    Pikaday.prototype = {
        ...
        setDate: function(date, preventOnSelect) {
            ...
            if (this._o.field) {
                ...
                var __date = new Date(this._d);
                this._o.field.value = __date.getFullYear() + '-' + (__date.getMonth() + 1) + '-' + __date.getDate();
