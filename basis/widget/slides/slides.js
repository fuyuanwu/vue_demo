/**
 * Artwork of Gallery: Simple slides
 *
 * Usage:
 <!doctype html>
<head>
...
(function($, window, document) {
    ...
    Plugin.prototype.init = function() {
        ...
        $element.siblings('.J-tr').click(function(e) {
            e.preventDefault();
            _this.stop(true);
            return _this.next(_this.options.navigation.effect);
        });
        $element.siblings('.J-tl').click(function(e) {
            e.preventDefault();
            _this.stop(true);
    ...
    return $.fn["slides"] = function(options) {
        return this.each(function() {
            if (!$.data(this, "plugin_" + "slides")) {
                return $.data(this, "plugin_" + "slides", new Plugin(this, options));
            }
        });
    };
})($, window, document);
