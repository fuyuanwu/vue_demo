//Source Origin from http://people.eku.edu/styere/Encrypt/JS-AES.html -->
//Updated by Dumbbell Yang at 2011-04-26
//dumbbellyang@gmail.com
//JavaScript AES Encrypt/Decrypt
...
//Add and Modified by Dumbbell Yang at 2011-04-30
...
(function() {
  ...
  //added by Dumbbell Yang at 2011-04-26
  //change from hex string to hex byte array
  ...
  //added by Dumbbell Yang at 2011-04-26
  //chang from and to ascii and hex
  ...
  // window.AES = {};
  // window.AES.encrypt = encrypt;
  // window.AES.decrypt = decrypt;

  window[RO].plugin.aes = {
    encrypt: encrypt,
    decrypt: decrypt
  };
  window[RO].plugin.aes.sencrypt = function(key, msg) {
    return window[RO].plugin.aes.encrypt(key, escape(msg));
  };
  window[RO].plugin.aes.sdecrypt = function(key, msg) {
    return unescape(window[RO].plugin.aes.decrypt(key, msg));
  };
})();