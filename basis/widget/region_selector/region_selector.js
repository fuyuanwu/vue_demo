$.extend(window[RO], {
    region_selector: function(pid, cid, did) {
        var DICT = {
            "北京": {
                "北京市": ["东城区", "西城区", "崇文区", "宣武区", "朝阳区", "丰台区", "石景山区", "海淀区", "门头沟区", "房山区", "通州区", "顺义区", "昌平区", "大兴区", "怀柔区", "平谷区", "密云县", "延庆县"]
            },
            "天津": {
                "天津市": ["和平区", "河东区", "河西区", "南开区", "河北区", "红桥区", "塘沽区", "汉沽区", "大港区", "东丽区", "西青区", "津南区", "北辰区", "武清区", "宝坻区", "宁河县", "静海县", "蓟县", "保税区", "经济技术开发区", "高新区", "滨海新区"]
            },
            "河北": {
                "石家庄市": ["长安区", "桥东区", "桥西区", "新华区", "井陉矿区", "裕华区", "井陉县", "正定县", "栾城县", "行唐县", "灵寿县", "高邑县", "深泽县", "赞皇县", "无极县", "平山县", "元氏县", "赵县", "辛集市", "藁城市", "晋州市", "新乐市", "鹿泉市", "高新技术开发区"],
                "唐山市": ["路南区", "路北区", "古冶区", "开平区", "丰南区", "丰润区", "滦县", "滦南县", "乐亭县", "迁西县", "玉田县", "唐海县", "遵化市", "迁安市", "高新区", "汉沽管理区", "海港开发区", "芦台开发区", "南堡开发区", "曹妃甸工业区"],
                "秦皇岛市": ["海港区", "山海关区", "北戴河区", "青龙满族自治县", "昌黎县", "抚宁县", "卢龙县", "经济技术开发区"],
                "邯郸市": ["邯山区", "丛台区", "复兴区", "峰峰矿区", "邯郸县", "临漳县", "成安县", "大名县", "涉县", "磁县", "肥乡县", "永年县", "邱县", "鸡泽县", "广平县", "馆陶县", "魏县", "曲周县", "武安市", "经济开发区"],
                "邢台市": ["桥东区", "桥西区", "邢台县", "临城县", "内丘县", "柏乡县", "隆尧县", "任县", "南和县", "宁晋县", "巨鹿县", "新河县", "广宗县", "平乡县", "威县", "清河县", "临西县", "南宫市", "沙河市"],
                "保定市": ["新市区", "南市区", "北市区", "满城县", "清苑县", "涞水县", "阜平县", "徐水县", "定兴县", "唐县", "高阳县", "容城县", "涞源县", "望都县", "安新县", "易县", "曲阳县", "蠡县", "顺平县", "博野县", "雄县", "涿州市", "定州市", "安国市", "高碑店市"],
            ...
            "内蒙古": {
                "呼和浩特市": ["回民区", "玉泉区", "新城区", "赛罕区", "土默特左旗", "托克托县", "和林格尔县", "清水河县", "武川县"],
                "包头市": ["东河区", "昆都仑区", "青山区", "石拐区", "白云矿区", "九原区", "土默特右旗", "固阳县", "达尔罕茂明安联合旗"],
                "乌海市": ["海勃湾区", "海南区", "乌达区"],
                "赤峰市": ["红山区", "元宝山区", "松山区", "阿鲁科尔沁旗", "巴林左旗", "巴林右旗", "林西县", "克什克腾旗", "翁牛特旗", "喀喇沁旗", "宁城县", "敖汉旗", "新城区"],
            ...
            "辽宁": {
                "沈阳市": ["和平区", "沈河区", "大东区", "皇姑区", "铁西区", "苏家屯区", "东陵区", "沈北新区", "于洪区", "辽中县", "康平县", "法库县", "新民市", "经济技术开发区", "浑南新区", "新城子经济技术开发区"],
                "大连市": ["中山区", "西岗区", "沙河口区", "甘井子区", "旅顺口区", "金州区", "长海县", "瓦房店市", "普兰店市", "庄河市", "开发区", "保税区"],
                ...
                "锦州市": ["古塔区", "凌河区", "太和区", "黑山县", "义县", "凌海市", "北镇市", "松山新区", "经济技术开发区"],
            ...
            "吉林": {
                "长春市": ["南关区", "宽城区", "朝阳区", "二道区", "绿园区", "双阳区", "农安县", "九台市", "榆树市", "德惠市", "净月经济开发区", "高新技术产业开发区"],
            ...
            "黑龙江": {
                ...
                "牡丹江市": ["东安区", "爱民区", "阳明区", "西安区", "东宁县", "林口县", "绥芬河市", "海林市", "宁安市", "穆棱市"],
            ...
            "福建": {
                ...
                "厦门市": ["思明区", "海沧区", "湖里区", "集美区", "同安区", "翔安区", "鼓浪屿区", "象屿保税区", "火炬高新区"],
                "莆田市": ["城厢区", "涵江区", "荔城区", "秀屿区", "仙游县"],
                "三明市": ["梅列区", "三元区", "明溪县", "清流县", "宁化县", "大田县", "尤溪县", "沙县", "将乐县", "泰宁县", "建宁县", "永安市"],
                "泉州市": ["鲤城区", "丰泽区", "洛江区", "泉港区", "惠安县", "安溪县", "永春县", "德化县", "金门县", "石狮市", "晋江市", "南安市", "经济技术开发区"],
            ...
            "江西": {
                "南昌市": ["东湖区", "西湖区", "青云谱区", "湾里区", "青山湖区", "南昌县", "新建县", "安义县", "进贤县", "经济技术开发区", "红谷滩新区", "高新技术产业开发区", "桑海经济技术开发区", "英雄经济开发区"],
            ...
            "河南": {
                "郑州市": ["中原区", "二七区", "管城回族区", "金水区", "上街区", "中牟县", "巩义市", "荥阳市", "新密市", "新郑市", "登封市", "高新技术开发区", "惠济区", "经济技术开发区", "郑东新区", "出口加工区"],
                "开封市": ["龙亭区", "顺河回族区", "鼓楼区", "杞县", "通许县", "尉氏县", "开封县", "兰考县", "金明区", "禹王台区"],
                "洛阳市": ["老城区", "西工区", "瀍河回族区", "涧西区", "吉利区", "洛龙区", "孟津县", "新安县", "栾川县", "嵩县", "汝阳县", "宜阳县", "洛宁县", "伊川县", "偃师市", "高新技术开发区", "经济技术开发区"],
            ...
            "湖北": {
                ...
                "宜昌市": ["西陵区", "伍家岗区", "点军区", "虢亭区", "夷陵区", "远安县", "兴山县", "秭归县", "长阳土家族自治县", "五峰土家族自治县", "宜都市", "当阳市", "枝江市", "经济技术开发区"],
                ...
                "省直辖县级行政单位": ["石河子市", "阿拉尔市", "图木舒克市", "五家渠市", "仙桃市", "潜江市", "天门市", "神农架林区"]
            },
            "湖南": {
                ...
                "永州市": ["冷水滩区", "祁阳县", "东安县", "双牌县", "道县", "江永县", "宁远县", "蓝山县", "新田县", "江华瑶族自治县", "零陵区"],
            ...
            "广东": {
                "广州市": ["荔湾区", "越秀区", "海珠区", "天河区", "白云区", "黄埔区", "番禺区", "花都区", "增城市", "从化市", "南沙区", "萝岗区"],
                "韶关市": ["武江区", "浈江区", "曲江区", "始兴县", "仁化县", "翁源县", "乳源瑶族自治县", "新丰县", "乐昌市", "南雄市"],
                "深圳市": ["罗湖区", "福田区", "南山区", "宝安区", "龙岗区", "盐田区", "光明新区", "坪山新区"],
                "珠海市": ["香洲区", "斗门区", "金湾区"],
                "汕头市": ["龙湖区", "金平区", "濠江区", "潮阳区", "潮南区", "澄海区", "南澳县"],
                "佛山市": ["禅城区", "南海区", "顺德区", "三水区", "高明区"],
                "江门市": ["蓬江区", "江海区", "新会区", "台山市", "开平市", "鹤山市", "恩平市"],
                "湛江市": ["赤坎区", "霞山区", "坡头区", "麻章区", "遂溪县", "徐闻县", "廉江市", "雷州市", "吴川市", "开发区"],
                "茂名市": ["茂南区", "茂港区", "电白县", "高州市", "化州市", "信宜市"],
                "肇庆市": ["端州区", "鼎湖区", "广宁县", "怀集县", "封开县", "德庆县", "高要市", "四会市", "高新技术产业开发区"],
                "惠州市": ["惠城区", "惠阳区", "博罗县", "惠东县", "龙门县", "大亚湾区", "仲恺高新区"],
                ...
                "潮州市": ["湘桥区", "潮安县", "饶平县"],
                "揭阳市": ["榕城区", "揭东县", "揭西县", "惠来县", "普宁市", "东山区", "普侨区", "大南山侨区"],
                "云浮市": ["云城区", "新兴县", "郁南县", "云安县", "罗定市"],
                "东莞市": ["南城区", "石龙镇", "长安镇", "虎门镇", "横沥镇", "寮步镇", "黄江镇", "清溪镇", "莞城区", "万江区", "东城区", "石碣镇", "茶山镇", "石排镇", "企石镇", "桥头镇", "谢岗镇", "东坑镇", "常平镇", "大朗镇", "塘厦镇", "凤岗镇", "厚街镇", "沙田镇", "道滘镇", "洪梅镇", "麻涌镇", "中堂镇", "高埗镇", "樟木头镇", "大岭山镇", "望牛墩镇"],
                "中山市": ["中山市"]
            },
            "广西": {
            ...
            "海南": {
                "海口市": ["秀英区", "龙华区", "琼山区", "美兰区"],
                "省直辖县级行政单位": ["五指山市", "琼海市", "儋州市", "文昌市", "万宁市", "东方市", "定安县", "屯昌县", "澄迈县", "临高县", "白沙黎族自治县", "昌江黎族自治县", "乐东黎族自治县", "陵水黎族自治县", "保亭黎族苗族自治县", "琼中黎族苗族自治县", "西、南、中沙群岛办事处"],
                "三亚市": ["河西区", "河东区", "田独镇", "凤凰镇", "三亚市", "崖城镇", "天涯镇", "育才乡", "海棠湾镇"]
            },
            "重庆": {
                "重庆市": ["万州区", "涪陵区", "渝中区", "大渡口区", "江北区", "沙坪坝区", "九龙坡区", "南岸区", "北碚区", "万盛区", "双桥区", "渝北区", "巴南区", "黔江区", "长寿区", "綦江县", "潼南县", "铜梁县", "大足县", "荣昌县", "璧山县", "梁平县", "城口县", "丰都县", "垫江县", "武隆县", "忠县", "开县", "云阳县", "奉节县", "巫山县", "巫溪县", "石柱土家族自治县", "秀山土家族苗族自治县", "酉阳土家族苗族自治县", "彭水苗族土家族自治县", "高新区", "江津区", "合川区", "永川区", "南川区"]
            },
            "四川": {
                "成都市": ["锦江区", "青羊区", "金牛区", "武侯区", "成华区", "龙泉驿区", "青白江区", "新都区", "温江区", "金堂县", "双流县", "郫县", "大邑县", "蒲江县", "新津县", "都江堰市", "彭州市", "邛崃市", "崇州市", "高新区", "高新西区"],
                "自贡市": ["自流井区", "贡井区", "大安区", "沿滩区", "荣县", "富顺县"],
                "攀枝花市": ["东区", "西区", "仁和区", "米易县", "盐边县"],
                "泸州市": ["江阳区", "纳溪区", "龙马潭区", "泸县", "合江县", "叙永县", "古蔺县"],
                "德阳市": ["旌阳区", "中江县", "罗江县", "广汉市", "什邡市", "绵竹市"],
                "绵阳市": ["涪城区", "游仙区", "三台县", "盐亭县", "安县", "梓潼县", "北川羌族自治县", "平武县", "江油市", "农科区", "经济技术开发区", "高新区", "仙海区"],
            ...
            "贵州": {
                "贵阳市": ["南明区", "云岩区", "花溪区", "乌当区", "白云区", "小河区", "开阳县", "息烽县", "修文县", "清镇市", "金阳新区"],
            ...
            "陕西": {
                "西安市": ["新城区", "碑林区", "莲湖区", "灞桥区", "未央区", "雁塔区", "阎良区", "临潼区", "长安区", "蓝田县", "周至县", "户县", "高陵县", "高新区"],
                "铜川市": ["王益区", "印台区", "耀州区", "宜君县", "新区"],
                "宝鸡市": ["渭滨区", "金台区", "陈仓区", "凤翔县", "岐山县", "扶风县", "眉县", "陇县", "千阳县", "麟游县", "凤县", "太白县"],
                "咸阳市": ["秦都区", "渭城区", "杨陵区", "三原县", "泾阳县", "兴平市", "乾县", "礼泉县", "永寿县", "彬县", "长武县", "旬邑县", "淳化县", "武功县"],
                "渭南市": ["临渭区", "华县", "潼关县", "大荔县", "合阳县", "澄城县", "蒲城县", "白水县", "富平县", "韩城市", "华阴市"],
                "延安市": ["宝塔区", "延长县", "延川县", "子长县", "安塞县", "志丹县", "吴旗县", "甘泉县", "富县", "洛川县", "宜川县", "黄龙县", "黄陵县"],
                "汉中市": ["汉台区", "南郑县", "城固县", "洋县", "西乡县", "勉县", "宁强县", "略阳县", "镇巴县", "留坝县", "佛坪县", "经济开发区"],
            ...
            "青海": {
                ...
                "海西蒙古族藏族自治州": ["格尔木市", "德令哈市", "乌兰县", "都兰县", "天峻县", "大柴旦行委"]
            },
            "宁夏": {
            ...
            "新疆": {
                ...
                "省直辖县级行政单位": ["石河子市", "阿拉尔市", "图木舒克市", "五家渠市"]
            }
            // ,
            // "港澳台": {
            //     "香港": ["香港特别行政区"],
        ...
        var DEFAULT_PROVINCE = '<option value="selectplease" disabled="disabled">省份/自治区</option>';
        var DEFAULT_CITY = '<option value="selectplease" disabled="disabled">城市/地区/自治州</option>';
        var DEFAULT_DISTRICT = '<option value="selectplease" disabled="disabled">区/县</option>';
        var _html = '';

        var SELECT_P = function() {
            return $("#" + pid);
        };
        var SELECT_C = function() {
            return $("#" + cid);
        };
        var SELECT_D = function() {
            return $("#" + did);
        };

        SELECT_P().change(function() {
            var _html = "";
            var key_val = DICT[SELECT_P().val()];
            if (key_val) {
                $.each(key_val, function(k, v) {
                    _html += '<option value="' + k + '">' + k + '</option>';
                });
            }
            SELECT_C().html(DEFAULT_CITY + _html).val("selectplease").trigger('change').prev(".input_field").addClass("c-disabled").val('城市/地区/自治州');
        });
        SELECT_C().change(function() {
            var _html = '';
            if (DICT[SELECT_P().val()]) {
                var key_val = DICT[SELECT_P().val()][SELECT_C().val()];
                if (key_val) {
                    $.each(key_val, function(k, v) {
            ...
            SELECT_D().html(DEFAULT_DISTRICT + _html);
            SELECT_D().val("selectplease").trigger('change').prev(".input_field").addClass("c-disabled").val('区/县');
        });

        $.each(DICT, function(k, v) {
            _html += '<option value="' + k + '">' + k + '</option>';
        });
        SELECT_P().html(DEFAULT_PROVINCE + _html).val("selectplease").change();
    }
});